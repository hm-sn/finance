...
<div class="leftnav">
    ...
    <ul style="display:block">
        ...
        <li><a href="addmanager.html" target="right"><span class="icon-caret-right"></span>添加用户</a></li>
        <li><a href="adv.html" target="right"><span class="icon-caret-right"></span>广告管理</a></li>
        <li><a href="book.html" target="right"><span class="icon-caret-right"></span>留言管理</a></li>
        <li><a href="column.html" target="right"><span class="icon-caret-right"></span>新闻管理</a></li>
    </ul>
...
<div class="admin">
    <iframe scrolling="auto" rameborder="0" src="book.html" name="right" width="100%" height="100%"></iframe>
</div>
